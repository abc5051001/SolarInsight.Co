...
const PLANS = [
  {
    ...
    price: "$550",
    sub: "Up to 20 panels",
    features: ["2× deionized wash", "Thermal inspection", "Gutter clearance", "Production report", "Money-back guarantee"],
    highlight: false,
  },
  {
    plan: "Standard",
    price: "$690",
    sub: "21–30 panels",
    features: ["2× deionized wash", "Thermal + EL inspection", "Gutter clearance", "Production report", "Money-back guarantee"],
    highlight: true,
  },
  {
    plan: "Premium",
    price: "$850",
    sub: "31+ panels",
    features: ["2× deionized wash", "Thermal + EL inspection", "Gutter clearance", "Annual soiling report", "Priority scheduling", "Money-back guarantee"],
    highlight: false,
  },
];
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-16">
          <Reveal>
            ...
            <p className="mt-6 text-white/50 text-[15px] leading-relaxed max-w-xl">
              One annual fee covers everything — cleaning, inspection, gutters, and reporting. No hidden charges, no per-visit fees.
            </p>
          </Reveal>
                ...
                <div className={`flex flex-col gap-6 p-8 rounded-2xl border h-full ${highlight ? "border-[#4ADE80]/40 bg-[#4ADE80]/5" : "border-white/10 bg-white/3"}`}>
                  ...
                  <div>
                    ...
                    <p className="text-4xl font-bold text-white mt-2">
                      {price}<span className="text-base font-normal text-white/40">/yr</span>
                    </p>
          ...
          <Reveal delay={0.2}>
            <div className="border-t border-white/10 pt-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div>
                <p className="text-white font-medium">Not sure which plan fits?</p>
                <p className="text-white/40 text-sm mt-1">Book a free audit — we'll assess your system and recommend the right tier.</p>
              </div>
              <button
                onClick={() => setBookOpen(true)}
